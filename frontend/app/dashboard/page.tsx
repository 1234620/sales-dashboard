  ...
  return (
    <div className={dashboardTheme.page}>
      <header className={dashboardTheme.header}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 md:py-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="flex items-start gap-4">
            <Link
              href="/"
              className="inline-flex items-center gap-1.5 text-sm font-medium text-gray-600 hover:text-[#880d1e] transition-colors mt-1 shrink-0"
            >
              <ArrowLeft className="w-4 h-4" aria-hidden />
              Home
            </Link>
            <div>
              <h1 className={dashboardTheme.headerTitle}>Sales Performance Dashboard</h1>
              <p className={dashboardTheme.headerSubtitle}>
                FMCG revenue analytics, forecasting, and anomaly monitoring
              </p>
            </div>
          </div>
      ...
      <footer className={dashboardTheme.footer}>
        ...
        <p className="mt-1">Internship Project · 2026</p>
      </footer>
    </div>
  );
}
